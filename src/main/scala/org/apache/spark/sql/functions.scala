...
object functions:
  ...
  def corr(col1: String, col2: String): Column = corr(Column(col1), Column(col2))
  def covar_pop(col1: Column, col2: Column): Column = callFn("covar_pop", col1, col2)
  def covar_pop(col1: String, col2: String): Column = covar_pop(Column(col1), Column(col2))
  def covar_samp(col1: Column, col2: Column): Column = callFn("covar_samp", col1, col2)
  def covar_samp(col1: String, col2: String): Column = covar_samp(Column(col1), Column(col2))
