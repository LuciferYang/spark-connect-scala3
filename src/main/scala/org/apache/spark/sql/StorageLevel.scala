...
object StorageLevel:
  ...
  val DISK_ONLY_3 = StorageLevel(true, false, false, false, 3)
  ...
  val MEMORY_ONLY_SER_2 = StorageLevel(false, true, false, false, 2)
  ...
  val MEMORY_AND_DISK_SER_2 = StorageLevel(true, true, false, false, 2)
