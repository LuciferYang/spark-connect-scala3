...
final case class PipelineEvent(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[PipelineEvent] {
    @transient
    ...
    def clearTimestamp: PipelineEvent = copy(timestamp = _root_.scala.None)
    def withTimestamp(__v: com.google.protobuf.timestamp.Timestamp): PipelineEvent = copy(timestamp = Option(__v))
    def getMessage: _root_.scala.Predef.String = message.getOrElse("")
    def clearMessage: PipelineEvent = copy(message = _root_.scala.None)
    def withMessage(__v: _root_.scala.Predef.String): PipelineEvent = copy(message = Option(__v))
    ...
    def companion: org.apache.spark.connect.proto.pipelines.PipelineEvent.type = org.apache.spark.connect.proto.pipelines.PipelineEvent
    // @@protoc_insertion_point(GeneratedMessage[spark.connect.PipelineEvent])
}

object PipelineEvent extends scalapb.GeneratedMessageCompanion[org.apache.spark.connect.proto.pipelines.PipelineEvent] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.apache.spark.connect.proto.pipelines.PipelineEvent] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.apache.spark.connect.proto.pipelines.PipelineEvent = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.apache.spark.connect.proto.pipelines.PipelineEvent] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = PipelinesProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = PipelinesProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = org.apache.spark.connect.proto.pipelines.PipelineEvent(
    timestamp = _root_.scala.None,
    message = _root_.scala.None
  )
  implicit class PipelineEventLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.apache.spark.connect.proto.pipelines.PipelineEvent]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.apache.spark.connect.proto.pipelines.PipelineEvent](_l) {
  ...
  ): _root_.org.apache.spark.connect.proto.pipelines.PipelineEvent = _root_.org.apache.spark.connect.proto.pipelines.PipelineEvent(
    timestamp,
    message
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[spark.connect.PipelineEvent])
}
